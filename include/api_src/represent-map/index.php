<?php
if(!file_exists(plugin_dir_path( __FILE__ ) . 'include/db.php')) require_once(plugin_dir_path( __FILE__ ) . 'installer.php');
...
if (isset($_GET['owner_name']) && $_GET['owner_name'] != '') {
	...
	<html>
	  <head>
	    ...
	    <link href="<?php echo plugins_url('bootstrap/css/bootstrap.css' , __FILE__ ); ?>" rel="stylesheet" type="text/css" />
	    <link href="<?php echo plugins_url('bootstrap/css/bootstrap-responsive.css' , __FILE__ ); ?>" rel="stylesheet" type="text/css" />
	    <link rel="stylesheet" href="<?php echo plugins_url('map.css?nocache=289671982568' , __FILE__ ); ?>" type="text/css" />
	    <link rel="stylesheet" media="only screen and (max-device-width: 480px)" href="<?php echo plugins_url('mobile.css' , __FILE__ ); ?>" type="text/css" />
	    <script src="<?php echo plugins_url('scripts/jquery-1.7.1.js' , __FILE__ ); ?>" type="text/javascript" charset="utf-8"></script>
	    <!-- <script src="//code.jquery.com/jquery-1.9.1.js" type="text/javascript" charset="utf-8"></script> -->
	    <script src="<?php echo plugins_url('bootstrap/js/bootstrap.js' , __FILE__ ); ?>" type="text/javascript" charset="utf-8"></script>
	    <script src="<?php echo plugins_url('bootstrap/js/bootstrap-typeahead.js' , __FILE__ ); ?>" type="text/javascript" charset="utf-8"></script>
	    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?sensor=false"></script>
	    <script type="text/javascript" src="<?php echo plugins_url('scripts/label.js' , __FILE__ ); ?>"></script>
	    ...
	    <script type="text/javascript">
	      ...
	      function initialize() {
	        ...
	        jQuery.each(markers, function(i, val) {
	          ...
	          // build this marker
	          var markerImage = new google.maps.MarkerImage("wp-content/plugins/startup_directory/include/api_src/represent-map/images/icons/"+val[1]+".png", null, null, null, iconSize);
	  ...
	  <body>
	            ...
	            echo "
	              <li class='category'>
	                <div class='category_item'>
	                  ...
	                  <a href='#' onClick=\"toggleList('$type[0]');\" class='category_info'><img src='" . plugins_url("images/icons/$type[0].png" , __FILE__ ) . "' alt='' />$type[1]<span class='total'> ($markers_total)</span></a>
	                </div>
	    ...
	    <div class="modal hide" id="modal_add">
	      <form id="modal_addform" class="form-horizontal" method="get">
